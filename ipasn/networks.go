...
// NetworksFilter interface is based on *IP.Net->Contains magically permits
// the building of larger, or recursive networks.
type NetworksFilter interface {
	// Contains reports whether the network includes ip.
	Contains(ip net.IP) bool
}

// Networks is a list of NetworkFilters
type Networks []NetworksFilter
...
func NoPrivateNetworks() NetworksFilter {
